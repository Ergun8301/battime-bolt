...
@media(max-width:880px){
 ...
 .lp-tarif-grid{grid-template-columns:1fr !important;max-width:380px !important;margin-left:auto !important;margin-right:auto !important;width:100%}
 .lp-tarif-inner{min-height:auto !important;justify-content:flex-start !important;gap:26px !important}
...
@media(max-width:560px){
 ...
 .lp-tarif-inner{padding:34px 18px 44px !important}
}`;
...
const BODY = `<!-- ============ HEADER ============ -->
  ...
  <!-- ============ TARIF ============ -->
  <section id="tarif" class="lp-tarif-sec" style="position:relative;background:#15120F;color:#F2EDE3;-webkit-font-smoothing:antialiased">
    <!-- ruban haut -->
    ...
    <div class="lp-tarif-inner" style="max-width:1080px;margin:0 auto;width:100%;min-height:calc(100vh - 72px);display:flex;flex-direction:column;justify-content:space-between;gap:30px;padding:46px 28px 40px">
      ...
      <!-- Les 3 offres -->
      <div class="lp-tarif-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:18px;align-items:stretch">
